#pragma checksum "C:\Users\gugup\OneDrive\Área de Trabalho\C#\Projetos\EasyHealth\EasyHealth\EasyHealth\EasyHealth\Client\Pages\Cadastro\Index.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "16832fbf75207c70694372c9d2e8ca83025a78ae"
// <auto-generated/>
...
#nullable disable
    ...
    public partial class Index : Microsoft.AspNetCore.Components.ComponentBase
    {
        ...
        {
            __builder.AddMarkupContent(0, "<h1>Cadastro Geral</h1>\r\n");
            __builder.AddMarkupContent(1, @"<div class=""row"">
    <div class=""col-md-4"">
        <ul class=""list-group list-group-flush"">
            <li class=""list-group-item"">Hospital</li>
            <a href=""#"" class=""list-group-item link-without-underline"">Insumo hospitalar</a>
            <a href=""SupplyCategory"" class=""list-group-item link-without-underline"">Categoria de insumo hospitalar</a>
        </ul>
    </div>
    <div class=""col-md-4"">
        <ul class=""list-group list-group-flush"">
    ...
    <div class=""col-md-4"">
        <ul class=""list-group list-group-flush"">
            <li class=""list-group-item"">Farmácia</li>                      
        </ul>
    </div>
</div>");
        }
